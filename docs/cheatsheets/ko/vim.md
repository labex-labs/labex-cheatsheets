---
title: 'Vim 명령어 치트 시트 | LabEx'
description: '빠른 텍스트 편집을 위한 Vim 명령어 치트 시트입니다. 모드, 이동, 입력, 삭제, 복사, 붙여넣기, 검색, 치환, 창, 탭, 버퍼 및 매크로를 빠르게 참고하세요.'
---
...
이 Vim 명령어 치트 시트를 명령줄에서 파일을 편집하기 위한 실용적인 참고 자료로 활용하세요. Vim 모드, 커서 이동, 입력 및 치환 명령, 비주얼 선택, 복사와 붙여넣기, 검색과 치환, 버퍼, 창, 탭, 매크로, 마크, 레지스터 및 기본 설정을 다룹니다.
</base-disclaimer-content>
</base-disclaimer>
