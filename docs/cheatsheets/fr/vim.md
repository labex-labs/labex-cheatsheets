---
title: 'Aide-mémoire des commandes Vim | LabEx'
description: 'Aide-mémoire des commandes Vim pour l’édition rapide de texte. Référence rapide pour modes, mouvements, insertion, suppression, copie, collage, recherche, remplacement, fenêtres, onglets, buffers et macros.'
---
...
Pratiquer les commandes Vim dans le terminal
</base-disclaimer-title>
<base-disclaimer-content>
Utilisez cet aide-mémoire des commandes Vim comme référence pratique pour éditer des fichiers en ligne de commande. Il couvre les modes Vim, mouvements du curseur, insertion et remplacement, sélections visuelles, copier-coller, recherche et remplacement, buffers, fenêtres, onglets, macros, marques, registres et configuration de base.
</base-disclaimer-content>
</base-disclaimer>
