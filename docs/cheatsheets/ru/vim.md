---
title: 'Шпаргалка по командам Vim | LabEx'
description: 'Шпаргалка по командам Vim для быстрого редактирования текста. Быстрый справочник по режимам, перемещению, вставке, удалению, копированию, вставке, поиску, замене, окнам, вкладкам, буферам и макросам.'
---
...
Практикуйте команды Vim в терминале
</base-disclaimer-title>
<base-disclaimer-content>
Используйте эту шпаргалку по командам Vim как практический справочник по редактированию файлов из командной строки. Она охватывает режимы Vim, перемещение курсора, команды вставки и замены, визуальные выделения, копирование и вставку, поиск и замену, буферы, окна, вкладки, макросы, метки, регистры и базовую настройку.
</base-disclaimer-content>
</base-disclaimer>
