---
title: 'Шпаргалка по командам Nmap | LabEx'
description: 'Шпаргалка по командам Nmap для сетевого сканирования. Быстрый справочник по обнаружению хостов, сканированию портов, определению сервисов, ОС, NSE-скриптам, форматам вывода и аудиту безопасности.'
...
<a target="_blank" href="https://labex.io/ru/learn/nmap">Практикуйте команды Nmap в лабораториях</a>
</base-disclaimer-title>
<base-disclaimer-content>
Используйте эту шпаргалку по командам Nmap как быстрый справочник по обнаружению сети, TCP и UDP сканам, определению сервисов/версий, fingerprinting ОС, настройкам времени, NSE-скриптам, проверкам уязвимостей, форматам вывода и практическому аудиту.
</base-disclaimer-content>
</base-disclaimer>
...
<BaseQuiz id="nmap-scan-1" correct="A">
  <template #question>
    Что делает по умолчанию базовое сканирование <code>nmap 192.168.1.1</code>?
  </template>
  ...
  <BaseQuizAnswer>
    По умолчанию Nmap сканирует 1000 наиболее распространенных TCP-портов. Чтобы сканировать все порты, используйте <code>-p-</code> или укажите конкретные порты с помощью <code>-p 80,443,22</code>.
  </BaseQuizAnswer>
</BaseQuiz>
...
<BaseQuiz id="nmap-ping-1" correct="A">
  ...
  <BaseQuizAnswer>
    Флаг <code>-sn</code> указывает Nmap выполнять только обнаружение хостов (ping-сканирование), без сканирования портов. Это полезно для быстрого определения того, какие хосты активны в сети.
  </BaseQuizAnswer>
</BaseQuiz>
