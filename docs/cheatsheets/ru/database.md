---
title: 'Шпаргалка по командам SQL | LabEx'
description: 'Шпаргалка по командам SQL для работы с базами данных. Быстрый справочник по CREATE, SELECT, INSERT, UPDATE, DELETE, JOIN, GROUP BY, индексам, транзакциям, пользователям, резервным копиям и лучшим практикам SQL.'
...
<a target="_blank" href="https://labex.io/ru/learn/database">Практикуйте команды SQL в лабораториях</a>
</base-disclaimer-title>
<base-disclaimer-content>
Используйте эту шпаргалку по командам SQL как практический справочник по созданию баз, проектированию таблиц, запросам, JOIN, агрегациям, индексам, транзакциям, правам пользователей, резервному копированию и оптимизации запросов.
</base-disclaimer-content>
</base-disclaimer>
