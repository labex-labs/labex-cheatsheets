---
title: 'Vim 命令速查表 | LabEx'
description: 'Vim 命令速查表，适用于快速文本编辑。快速参考模式、移动、插入、删除、复制、粘贴、搜索、替换、窗口、标签页、缓冲区和宏。'
---
...
将此 Vim 命令速查表作为命令行编辑文件的实用参考。内容涵盖 Vim 模式、光标移动、插入和替换命令、可视选择、复制粘贴、搜索替换、缓冲区、窗口、标签页、宏、标记、寄存器和配置基础。
</base-disclaimer-content>
</base-disclaimer>
