---
title: 'Folha de consulta de comandos Vim | LabEx'
description: 'Folha de consulta de comandos Vim para edição rápida de texto. Referência rápida para modos, movimento, inserção, exclusão, cópia, colagem, busca, substituição, janelas, abas, buffers e macros.'
---

<base-title :title="frontmatter.title" :description="frontmatter.description">
Folha de consulta de comandos Vim
</base-title>

<base-disclaimer>
<base-disclaimer-title>
Pratique comandos Vim no terminal
</base-disclaimer-title>
<base-disclaimer-content>
Use esta folha de consulta de comandos Vim como referência prática para editar arquivos pela linha de comando. Ela cobre modos do Vim, movimento do cursor, comandos de inserção e substituição, seleções visuais, copiar e colar, busca e substituição, buffers, janelas, abas, macros, marcas, registradores e configuração básica.
</base-disclaimer-content>
</base-disclaimer>
