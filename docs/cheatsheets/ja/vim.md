---
title: 'Vim コマンドチートシート | LabEx'
description: '高速なテキスト編集向けの Vim コマンドチートシート。モード、移動、挿入、削除、コピー、貼り付け、検索、置換、ウィンドウ、タブ、バッファ、マクロのクイックリファレンス。'
---
...
この Vim コマンドチートシートを、コマンドラインからファイルを編集するための実用リファレンスとして使用してください。Vim モード、カーソル移動、挿入と置換、ビジュアル選択、コピーと貼り付け、検索と置換、バッファ、ウィンドウ、タブ、マクロ、マーク、レジスタ、基本設定を扱います。
</base-disclaimer-content>
</base-disclaimer>
