...
// Set frontmatter when component mounts or props change
// This allows SEO meta tags to use page-specific frontmatter data
watch(
...
<template>
  ...
  >
    ...
    >
      <button
        v-if="isSupported"
        class="transition duration-200 hover:text-primary-500"
        @click="startShare"
      >
        <svg
