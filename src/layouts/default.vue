...
const rootRepositoryRoutes: string[] = []
</script>
        ...
        <the-footer
          :repository="
            !rootRepositoryRoutes.includes(route.name as string)
              ? 'https://github.com/labex-labs/labex-cheatsheets/blob/master/docs'
              : 'https://github.com/labex-labs/labex-cheatsheets/blob/master/src/pages'
          "
        />
      </div>
